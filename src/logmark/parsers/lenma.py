...
from logparser.LenMa import LogParser as LenMaImpl
from .base import BaseParser

class LenMaParser(BaseParser):
    def __init__(self, **kwargs: Any):
        super().__init__(**kwargs)
        self.outdir = kwargs.get("outdir", "data/results/lenma/")
    ...
    def parse_line(self, line: str) -> dict:
        if self.df_result is None:
            raise RuntimeError("LenMaParser must be fitted before calling parse_line.")
